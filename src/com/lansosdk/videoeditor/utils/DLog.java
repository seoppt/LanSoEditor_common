...
public class DLog {
    ...
    public static final boolean ENABLE_INFO = ISDEBUG;
    public static final boolean ENABLE_WARN = ISDEBUG;
    public static final boolean ENABLE_DEBUG = ISDEBUG;
    public static final boolean ENABLE_VERBOSE = ISDEBUG;
